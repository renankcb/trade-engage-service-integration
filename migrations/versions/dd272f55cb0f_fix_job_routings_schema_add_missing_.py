...
def upgrade() -> None:
    ...
    op.add_column('job_routings', sa.Column('sync_status', sa.Enum('pending', 'synced', 'failed', 'completed', name='sync_status_enum'), nullable=False, server_default='pending'))
    op.add_column('job_routings', sa.Column('external_id', sa.String(length=255), nullable=True))
    op.add_column('job_routings', sa.Column('last_synced_at', sa.DateTime(), nullable=True))
    op.add_column('job_routings', sa.Column('retry_count', sa.Integer(), nullable=False, server_default='0'))
    ...
    op.create_index('ix_job_routings_last_synced_at', 'job_routings', ['last_synced_at'])
