...
class HealthChecker:
    ...
    async def _check_external_apis(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # Overall status
            all_healthy = all(
                api["status"] == "healthy" for api in external_apis.values()
            )
            ...
            return {
                ...
                "apis": external_apis,
                "healthy_count": sum(
                    1 for api in external_apis.values() if api["status"] == "healthy"
                ),
    ...
    async def _check_servicetitan_api(self) -> Dict[str, Any]:
        ...
        try:
            ...
            logger.error("ServiceTitan API health check failed", error=str(e))
            return {
                "status": "unhealthy",
                "error": str(e),
                "last_check": "2024-01-01T00:00:00Z",
