...
class ServiceTitanTransformer:
    ...
    def transform_lead_request(
        ...
        return ServiceTitanLeadRequest(
            ...
            customer_name=lead_data.homeowner.name,
            customer_phone=lead_data.homeowner.phone,
            customer_email=lead_data.homeowner.email,
            address=lead_data.address.street,
            city=lead_data.address.city,
            state=lead_data.address.state,
            zip_code=lead_data.address.zip_code,
            priority="normal",
            notes=None
        )
    ...
    def transform_lead_response(
        self, 
        response: ServiceTitanLeadResponse
    ) -> CreateLeadResponse:
    ...
    def transform_status_response(
        self, 
        response: ServiceTitanStatusResponse
    ) -> Dict[str, Any]:
    ...
    def transform_lead_to_job(
        self, 
        lead_data: ServiceTitanLeadResponse
    ) -> Dict[str, Any]:
