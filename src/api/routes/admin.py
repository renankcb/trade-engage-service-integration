...
async def stop_workers(
    ...
    try:
        ...
        return {
            ...
            "data": {"workers_running": False, "active_workers": 0},
        }
...
async def restart_worker(
    worker_name: str, worker_manager: WorkerManager = Depends(get_worker_manager)
) -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "data": {"worker_name": worker_name, "status": "restarted"},
        }
...
async def get_system_metrics(
    ...
    try:
        ...
        total_tasks = sum(
            ...
            for worker in ["poll_worker", "outbox_worker"]
        )
